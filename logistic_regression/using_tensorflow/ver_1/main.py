...
# train dataset
#x1 = np.random.multivariate_normal(mean=mean1,
#                                   cov=cov1, size=number_of_data1)
x1 = tf.random.normal(shape=[number_of_data1, 2], mean=mean1)
x2 = tf.random.normal(shape=[number_of_data2, 2], mean=mean2)
#x2 = np.random.multivariate_normal(mean=mean2,
#                                   cov=cov2, size=number_of_data2)
X = tf.stack(x1, axis=0)
X = tf.stack(x2, axis=0)
print(1)
print(X)
...
#x1_test = np.random.multivariate_normal(mean=mean1_test,
#                                        cov=cov1_test, size=number_of_data1)
#x2_test = np.random.multivariate_normal(mean=mean2_test,
#                                        cov=cov2_test, size=number_of_data2)
...
b = tf.Variable(tf.random.normal(shape=(number_of_data, 1)))
